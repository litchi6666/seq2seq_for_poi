...
source_vocab_to_int, target_vocab_to_int, _, _ = word_vocab(file)

source_text_to_int, target_text_to_int = get_sts2idx(file,source_vocab_to_int,target_vocab_to_int)
...
with tf.Session(graph=train_graph) as sess:
    ...
    saver.save(sess, "checkpoints_poi_n_v_clean/dev")
